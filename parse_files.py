...
def get_comment_header():
    return ",".join(['comment_id', 'status_id', 'parent_id', 'comment_message', 'comment_author',
                     'comment_published', 'num_reactions', 'num_likes', 'num_loves', 'num_wows',
                     'num_hahas', 'num_sads', 'num_angrys', 'num_special'])


def get_share_header():
    return ",".join(['status_id', 'sharer', 'status_shared'])


def get_reaction_header():
    return ",".join(['status_id', 'type_of_reaction', 'reactor', 'reacted'])
...
if __name__ == '__main__':
    ...
    statuses_path = "dataset/test_statuses.csv"
    comments_path = "dataset/test_comments.csv"
    shares_path = "dataset/test_shares.csv"
    reactions_path = "dataset/test_reactions.csv"

    adjust_date_time(statuses_path, comments_path, shares_path, reactions_path)
